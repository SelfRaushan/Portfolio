...
async def run_test():
    ...
    try:
        ...
        # Enter valid admin username/email and password, then click on login button.
        ...
        await page.wait_for_timeout(3000); await elem.fill('validAdminPassword123')
        ...
        assert False, 'Test failed: Unable to verify successful login and JWT token.'
